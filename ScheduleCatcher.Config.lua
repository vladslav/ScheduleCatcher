...
huntList = { "Snorlax", "Staryu", "Vanillite", "Charmander", "Magmar" }
...
--Time 00:00 ~ 00:59
scheduleList[0]["map"] = "Route 12"
scheduleList[0]["zone"] = {"grass"}
scheduleList[0]["sync"] = "Careful"
scheduleList[0]["ignoreFarm"] = false

--Time 04:00 ~ 04:59
scheduleList[4]["map"] = "Route 19"
scheduleList[4]["zone"] = {"water"}
scheduleList[4]["sync"] = "Timid"
scheduleList[4]["ignoreFarm"] = false

--Time 12:00 ~ 12:59
scheduleList[12]["map"] = "Cinnabar mansion 3"
scheduleList[12]["zone"] = {1,14,14,25}
scheduleList[12]["sync"] = "Timid"
scheduleList[12]["ignoreFarm"] = false

--Time 20:00 ~ 20:59
scheduleList[20]["map"] = "Route 12"
scheduleList[20]["zone"] = {"grass"}
scheduleList[20]["sync"] = "Careful"
scheduleList[20]["ignoreFarm"] = false
